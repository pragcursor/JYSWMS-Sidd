    ...
    */
    ...
    function lookForExistingRecords(context) {
        try {
            ...
            //     if (!isNaN(portalNumber) && portalNumber >= 467 && portalNumber <= 1000) {
    ...
    //Backup code - please don't remove MarkAsPicked Function
        ...
        try {
            ...
            for (var d = 0; d < requestBody.data.length; d++) {
                ...
                for (var i = 0; i < salesOrders.length; i++) {
                    ...
                    // var trackingNumbers = (so.labelData || []).map(function (label) {
                    //     return {
                    //         trackingNumber: label.sscc_code || label.tracking_number,
                    //         model: label.model
                    //     };
                    // });
                    // var trackingNumbers  = [];
                    ...
                    // //  Build result
                    // if (ssccList.length) {
                    //     // Pair each tracking with each SSCC
                    //     trackingList.forEach(function (tn) {
                    //         ssccList.forEach(function (sscc) {
                    ...
                    //     });
                    // } else {
                    //     // No labelData2 → only tracking numbers
                    //     trackingList.forEach(function (tn) {
                    //         trackingNumbers.push({
                    //             ssccCode: tn,
                    //             trackingNumber: ""
